...
$(function () {
    //计算价格
        $(document).on("change",".cost_price",function(){
            ...
            var jiage = $("#cost_price"+id).val();
            checkPrice(jiage,id)

            var original_price=parseInt($("#cost_price"+id).attr('original_price'));
            if(original_price<parseInt(jiage)){
                $("#float"+id).val("come-up");
        ...
        //零售
        function retail_price(jiage,bfb,id){
            ...
            if(retail_price.toString().length <3 && retail_price.toString().length >=2){
                ...
                $("#retail_price"+id).val(parseInt(zls));
            }
            //百
        ...
        //会员
        function member_price(jiage,bfb,id){
            ...
            if(member_price.toString().length <3 && member_price.toString().length >=2){
                ...
                $("#member_price"+id).val(parseInt(zhy));
            }
            //百
        ...
        //合作
        function cooperation_price(jiage,bfb,id){
            ...
            if(cooperation_price.toString().length <3 && cooperation_price.toString().length >=2){
                ...
                $("#cooperation_price"+id).val(parseInt(zhz));
            }
            //百
        ...
        //核心
        function core_price(jiage,bfb,id){
            ...
            if(core_price.toString().length <3 && core_price.toString().length >=2){
                ...
                $("#core_price"+id).val(parseInt(zhx));
            } //百
            ...
            if(core_price.toString().length <7 && core_price.toString().length >=6){
                ...
                //alert(r); alert(r1); alert(r2); alert(r3); alert(r4); alert(r5);
                $("#core_price"+id).val(parseInt(zhx));
            }
            if(core_price.toString().length >=7) {
                alert("超出计算范围  请手动输入");
            var jiage=parseInt($("#cost_price"+id).attr('original_price'));
                $("#cost_price"+id).val(jiage);
              checkPrice(jiage,id);
            }
        }
        function checkPrice(jiage,id) {
                core_price(jiage,0.95,id);
                cooperation_price(jiage,0.9,id);
                member_price(jiage,0.8,id);
                retail_price(jiage,0.5,id);
