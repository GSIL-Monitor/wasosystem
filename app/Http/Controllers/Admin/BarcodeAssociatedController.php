...
class BarcodeAssociatedController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        switch ($status) {
            case 'loan_out': {
                $barcode_associateds = $this->barcode_associatedServices->loan_outs($status);
                break;
            }
            ...
            case  'quality_return': {
                $barcode_associateds = $this->barcode_associatedServices->quality_returns($status);
...
//     return view('admin.barcode_associateds.create_and_edit', compact('status','barcode_associated'));
    }
