            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <div class="group-btns pull-right">
                        <a href="{{ route('log-viewer::logs.show', [$log->date]) }}" class="btn btn-sm btn-success" >
                    ...
                    <form action="{{ route('log-viewer::logs.search', [$log->date, $level]) }}" method="GET">
                        <div class=form-group">
                            <div class="input-group">
                                <input id="query" name="query" class="form-control"  value="{!! $query !!}" placeholder="在这里输入关键字搜索">
            ...
            <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">删除 {{ $log->date  }} 日志文件</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p>你确定要 <span class="badge badge-danger">删除</span> 这个日志文件 <span class="badge badge-primary">{{ $log->date }}</span> ?</p>
                    </div>
