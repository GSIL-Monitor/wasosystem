<div class="orderList MainOrder">
    ...
    <div class="price"><span class="pri danjia" data-id="{{ $order->unit_price }}">{{ $order->unit_price }}</span>.00元
    </div>
    <div class="num">
        <div class="num_box">
...
<div class="detailTable">
    <ul>
        ...
        @endforeach
        <li><span class="DTit">温馨提示</span><span><span style="color: red">*以上内容仅供参考，不构成任何约束和承诺，详情及价格请联系客服！</span></span>
            <div class="clear"></div>
        </li>
    </ul>
