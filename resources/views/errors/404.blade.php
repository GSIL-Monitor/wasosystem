...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/E404.css') }}" />
...
<div id="header">
    <div class="wrap headWrap">
        <div class="logo"><a href="/"><img src="{{ asset('pic/logo.png') }}"/></a></div>

        <div class="user_control">
            <div class="headPhone"><a href="{{ route('contact') }}"><img src="{{ asset('pic/headPhone.png') }}"></a></div>
            <div class="headIcon"><span><i title="手机访问"></i></span></div>
            <div class="user"><div title="个人中心" class="user_login"><a href="{{ route('member_center') }}"><img src="{{ asset('pic/login_btn.png') }}"></a></div></div>
...
<div class="body">
    <div class="wrap">
        <div class="errorPic"><img src="{{ asset('pic/404.png') }}"></div>
        ...
        <div class="errorLinks">
            ...
            <div class="moreLinks">
                ...
                <dl>
                    <dt>产品分类</dt>
                    <dd>
                        @foreach($complete_machines as $item)
                            <a href="{{ route('server.index',$item->id) }}">{{ $item->name }}</a>
                        @endforeach
                ...
                <dl>
                    <dt>快速选型</dt>
                    <dd>
                        <a href="{{ route('server.index','complete_machine') }}">服务器、存储选型</a>
                        <a href="{{ route('server.index','graphic_workstation_designer_computer') }}">图工及设计师电脑选型</a>
                        <a href="{{ route('in_depth_customization') }}">深度定制</a>
                        <a href="{{ route('it_outsourcing') }}">IT服务外包</a>
                    </dd>
                </dl>
                <dl>
                    <dt>解决方案</dt>
                    <dd>
                        @foreach($common_solutions as $item)
                            <a href="{{ route('solution.show',$item->id) }}" name="">{{ $item->name }}</a>
                        @endforeach
                ...
                <dl>
                    <dt>关于网烁</dt>
                    <dd>
                        <a href="{{ route('about') }}">公司介绍</a>
                        <a href="{{ route('honor') }}">荣誉资质</a>
                ...
                <dl>
                    <dt>服务支持</dt>
                    <dd>
                        <a href="{{ route('service_support.index') }}">自助服务</a>
                        <a href="{{ route('service_support.service_clause',43) }}">购买指南</a>
                        <a href="{{ route('service_support.service_clause',40) }}">服务条款</a>
                        <a href="{{ route('orders.index') }}">订单信息查询</a>
                    </dd>
                </dl>
                <dl>
                    <dt>新闻资讯</dt>
                    <dd>
                        <a href="{{ url('news_gongsi.html') }}">网烁新闻</a>
                        <a href="{{ url('news_hangye.html') }}">行业新闻</a>
                        <a href="{{ url('news_jishu.html') }}">技术知识</a>
                    </dd>
                </dl>
            </div>
        </div>
                    ...
                    <div class="f_d_right">
                        <ul>
                            ...
                            <li class="weixin">
                                ...
                                <img class="hidePic" src="{{ json_decode(getImages(setting('contact_wechat')),true)[0]['url1'] }}"/>
                            </li>
                            <div class="clear"></div>
                        </ul>
                    </div>
