<div class="JJList">
    <ul class="maxUl" id="app">
        ...
        @else
            {!! Form::model($user,['route'=>['admin.users.update',$user->id],'id'=>'users','method'=>'put','onsubmit'=>'return false']) !!}
        @endif
            <li>
            ...
            <li>
                ...
                <div class="liRight">
                    {!!  Form::email('email',old('email'),['placeholder'=>'请输入邮箱',"class"=>'checkNull']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li>
                ...
                <div class="liRight">
                    @if(Route::is('admin.users.create'))
                        {!!  Form::text('password',old('password'),['placeholder'=>'请输入密码',"class"=>'checkNull']) !!}
                    @else
                        {!!  Form::text('password',old('password',''),['placeholder'=>'为空则不修改',"class"=>'']) !!}
                    @endif
            ...
            <li>
                ...
                <div class="liRight">
                    {!!  Form::select('grade',$parameters['grades'],old('grade'),['placeholder'=>'账户级别',"class"=>'checkNull select2']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li>
                ...
                <div class="liRight">
                    {!!  Form::select('administrator',$parameters['admins'],old('administrator'),['placeholder'=>'管理员',"class"=>'checkNull select2']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li>
                ...
                <div class="liRight">
                    {!!  Form::select('tax_rate',$parameters['tax_rate'],old('tax_rate'),['placeholder'=>'会员税率',"class"=>'checkNull select2']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li>
                ...
                <div class="liRight">
                    {!!  Form::select('message_type',$parameters['message_type'],old('tax_rate'),['placeholder'=>'信息接收',"class"=>'checkNull select2']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li>
            ...
            <li>
                ...
                <div class="liRight">
                    {!!  Form::text('address',old('address'),['placeholder'=>'客户位置',"class"=>'']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li>
