    ...
    <li>
        ...
        <div class="liRight">
            {!!  Form::text('serial_number',old('serial_number', 'CK'.date('YmdHis',time())),['placeholder'=>'序列号',"class"=>'checkNull','readonly']) !!}
        </div>
        <div class="clear"></div>
    </li>
    <li>
    ...
    <li>
        ...
        <div class="liRight">
            {!!  Form::select('user_id',$users,old('user_id'),['placeholder'=>'收货单位',"class"=>'checkNull select2']) !!}
        </div>
        <div class="clear"></div>
    </li>
