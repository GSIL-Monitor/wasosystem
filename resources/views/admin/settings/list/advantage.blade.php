<li>
    ...
    <div class="liRight">
        ...
        <span class="greenWord">用法: setting('{{ $type }}_members_base') </span>
    </div>
    <div class="clear"></div>
</li>
<li>
    ...
    <div class="liRight">
        <textarea  name="{{ $type }}_members_base_description"> {{ old($type.'_members_base_description',setting($type.'_members_base_description')) }} </textarea>
        <span class="greenWord">用法: setting('{{ $type }}_members_base_description') </span>
    </div>
    <div class="clear"></div>
</li>
<li>
    ...
    <div class="liRight">
        ...
        <span class="greenWord">用法: setting('{{ $type }}_committeeman') </span>
    </div>
    <div class="clear"></div>
</li>
<li>
    ...
    <div class="liRight">
        <textarea  name="{{ $type }}_committeeman_description"> {{ old($type.'_committeeman_description',setting($type.'_committeeman_description')) }} </textarea>
        <span class="greenWord">用法: setting('{{ $type }}_committeeman_description') </span>
    </div>
    <div class="clear"></div>
</li>
<li>
    ...
    <div class="liRight">
        ...
        <span class="greenWord">用法: setting('{{ $type }}_soem') </span>
    </div>
    <div class="clear"></div>
</li>
<li>
    ...
    <div class="liRight">
        <textarea  name="{{ $type }}_soem_description"> {{ old($type.'_soem_description',setting($type.'_soem_description')) }} </textarea>
        <span class="greenWord">用法: setting('{{ $type }}_soem_description') </span>
    </div>
    <div class="clear"></div>
</li>
<li>
    ...
    <div class="liRight">
        ...
        <span class="greenWord">用法: setting('{{ $type }}_stap') </span>
    </div>
    <div class="clear"></div>
</li>
<li>
    ...
    <div class="liRight">
        <textarea  name="{{ $type }}_stap_description"> {{ old($type.'_stap_description',setting($type.'_stap_description')) }} </textarea>
        <span class="greenWord">用法: setting('{{ $type }}_stap_description') </span>
    </div>
    <div class="clear"></div>
</li>
