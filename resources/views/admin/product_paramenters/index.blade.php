                ...
                @foreach($product_paramenters as $product_paramenter)
                    <tr>
                        ...
                        <td ><input type="text"  name="edit[{{ $product_paramenter->id }}][danwei]"
                                   value="{{ $product_paramenter->danwei }}" class="zyw_w50"></td>
                        <td class="">
                        ...
                        <td>
                            <Poptip trigger="hover">
                                <span style="cursor:pointer">{{ config('status.procuctParamentselectShow')[$product_paramenter->type] }}</span>
                                <div slot="content">
                        ...
                        <td class="tableMoreHide">{{ $product_paramenter->updated_at->format('Y-m-d') }}</td>
