...
//                 orient: 'vertical',
                ...
                y: 'bottom',
                selectedMode:true,
                data:['总销售额({{ $total_prices  }})','已回款({{ $account_paid }})','发出未结({{ $no_payment  }})'
                    ]
            },
            series: [
                {
                    ...
                    data:[
                        { value:'{{ $total_prices }}',name:'总销售额({{ $total_prices  }})' },
                        { value:'{{ $account_paid }}',name:'已回款({{ $account_paid }})' },
                        { value:'{{ $no_payment  }}',name:'发出未结({{ $no_payment  }})' }
                    ]
                }
            ]
        };
