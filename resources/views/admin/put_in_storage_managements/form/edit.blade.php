<ul class="halfTwoUl">
        ...
        <li>
            ...
            <li>
                ...
                <div class="liRight">
                    {!!  Form::text('finish_procurement_number',old('finish_procurement_number'),['placeholder'=>'录入条目',"class"=>'checkNull',':readonly'=>'isDisabled','v-model'=>'finish_procurement_number_count']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li>
