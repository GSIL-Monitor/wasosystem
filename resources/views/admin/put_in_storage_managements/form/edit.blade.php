<ul class="halfTwoUl">
            <li>
                ...
                <div class="liRight">
                    {!!  Form::text('serial_number',old('serial_number',$put_in_storage_management->serial_number ?? 'RK'.date('YmdHis',time())),['placeholder'=>'procurement_plan',"class"=>'checkNull','readonly']) !!}
                </div>
                <div class="clear"></div>
            </li>
        <li>
        ...
        <li>
            ...
            <div class="liRight">
                {!!  Form::text('procurement_number',old('procurement_number'),['placeholder'=>'采购数量',"class"=>'checkNull OneNumber',':readonly'=>'isDisabled',"v-model"=>'procurement_number']) !!}
            </div>
            <div class="clear"></div>
        </li>
            <li>
                ...
                <div class="liRight">
                    {!!  Form::text('finish_procurement_number',old('finish_procurement_number'),['placeholder'=>'录入条目',"class"=>'checkNull',':readonly'=>'isDisabled || finish_procurement_number','v-model'=>'finish_procurement_number_count']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li>
