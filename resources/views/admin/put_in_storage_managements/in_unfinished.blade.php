                ...
                <table class="listTable">
                    ...
                    @forelse($put_in_storage_managements as $put_in_storage_management)
                        <tr>
                            ...
                            <td>{{ $put_in_storage_management->finish_procurement_number }}</td>
                            <td><span class="redWord">{{ config('status.procurement_plans_statuss')[$put_in_storage_management->procurement_status] }}</span></td>
                            ...
                            <td class=""><a class="changeWeb"
                                            data_url="{{ route('admin.put_in_storage_managements.two_code',$put_in_storage_management->id) }}">二级条码</a></td>
                        </tr>
                    @empty
