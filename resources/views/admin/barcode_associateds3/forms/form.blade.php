<div class="JJList">
    <ul class="halfTwoUl" id="app">
        {!! Form::model($barcode_associated['procurement_plan'],['route'=>['admin.barcode_associateds.store'],'id'=>'barcode_associateds','method'=>'post','onsubmit'=>'return false']) !!}
        <li>
        ...
        <li>
            ...
            <div class="liRight">
                {!!  Form::text(null,$barcode_associated['procurement_plan']->products->title,['placeholder'=>'产品类型',"class"=>'checkNull','readonly']) !!}
            </div>
            <div class="clear"></div>
        </li>
        <li>
            ...
            <div class="liRight">
                {!!  Form::hidden('product_good_id',old('product_good_id',$barcode_associated['procurement_plan']->product_goods->id),['placeholder'=>'产品规格',"class"=>'checkNull','readonly']) !!}
                {!!  Form::text(null,$barcode_associated['procurement_plan']->product_goods->name,['placeholder'=>'产品规格',"class"=>'checkNull','readonly']) !!}
            </div>
            <div class="clear"></div>
        </li>
        <li>
            ...
            <div class="liRight">
                {!!  Form::text(null,$barcode_associated['procurement_plan']->updated_at,['placeholder'=>'入库时间',"class"=>'checkNull','readonly']) !!}
            </div>
            <div class="clear"></div>
        </li>
        <li>
        ...
        <li>
            ...
            <div class="liRight">
                ...
                @else
                    {!!  Form::select('current_state',array_only(config('status.barcode_associateds_type'),['test_return','test_to_procurement']),old('current_state'),['placeholder'=>'选择事件',"class"=>'checkNull select2']) !!}
                @endif
            </div>
            <div class="clear"></div>
        </li>
        ...
        <li>
            ...
            <div class="liRight">
                ...
                @endphp
                {!!  Form::text(null,$admin_id[$barcode_associated['procurement_plan']->purchase ?? admin()->id],['placeholder'=>'采购人员',"class"=>'checkNull','readonly']) !!}
            </div>
            <div class="clear"></div>
        </li>
        <li>
        ...
        <li class="allLi">
            ...
            <div class="liRight">
                ...
                {!!  Form::hidden('order_id',old('order_id',0),['placeholder'=>'订单id',"class"=>'','readonly']) !!}
                ...
                {!!  Form::hidden('warehouse_out_management_id',old('warehouse_out_management_id',0),['placeholder'=>'出库id',"class"=>'','readonly']) !!}
               @php @endphp
                {!!  Form::textarea('postscript',old('postscript',
                  $barcode_associated['procurement_plan']->postscript ??
                    $barcode_associated['warehouse_out_management']->postscript ??
                $barcode_associated['procurement_plan']->postscript
                ),
                ['placeholder'=>'信息备注',"class"=>'']) !!}
            </div>
            <div class="clear"></div>
        </li>
        <div class="clear"></div>
