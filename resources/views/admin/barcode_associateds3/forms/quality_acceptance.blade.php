<div class="JJList">
    <ul class="halfTwoUl" id="app">
        ...
        <li>
            ...
            <div class="liRight">
                {!!  Form::hidden('product_good_id',old('product_good_id',$barcode_associated['barcode_associated']->product_good->id),['placeholder'=>'产品规格',"class"=>'checkNull','readonly']) !!}
                {!!  Form::text(null,$barcode_associated['barcode_associated']->product_good->name,['placeholder'=>'产品规格',"class"=>'checkNull','readonly']) !!}
            </div>
            <div class="clear"></div>
        </li>
        <li>
            <div class="liLeft">代管时间：</div>
            <div class="liRight">
                {!!  Form::text(null,$barcode_associated['barcode_associated']->updated_at,['placeholder'=>'代管时间',"class"=>'checkNull','readonly']) !!}
            </div>
            <div class="clear"></div>
        </li>
        <li>
        ...
        @if(!Request::has('search'))
            <li>
                ...
                <div class="liRight">
                    ...
                    @else
                        {!!  Form::select('current_state',array_only(config('status.barcode_associateds_type'),['quality_take_away','escrow_to_storage','breakage']),old('current_state'),['placeholder'=>'选择事件',"class"=>'checkNull','v-model'=>'selected','@change'=>'changeSelect()']) !!}
                    @endif
        ...
        @else
            <li>
                ...
                <div class="liRight">
                    {!!  Form::select('product_colour',array_only(config('status.barcode_associateds_type'),['new','good','bad']),old('product_colour'),['placeholder'=>'产品成色',"class"=>'checkNull','disabled']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li>
                ...
                <div class="liRight">
                    {!!  Form::text('two_code',old('two_code'),['placeholder'=>'关联条码',"class"=>'checkNull','disabled']) !!}
                </div>
                <div class="clear"></div>
            </li>
        @endif
        <li  v-if="showSelect">
            <div class="liLeft">产品成色：</div>
            <div class="liRight">
                {!!  Form::select('product_colour',array_only(config('status.barcode_associateds_type'),['new','good','bad']),old('product_colour',''),['placeholder'=>'产品成色',"class"=>'checkNull select2','v-model'=>'color']) !!}
            </div>
            <div class="clear"></div>
        </li>
        <li>
        ...
        <li>
            ...
            <div class="liRight">
                @if(Request::has('search'))
                    {!!  Form::text('admin',old('admin',$admin_id[$barcode_associated['barcode_associated']->admin]),['placeholder'=>'关联客户',"class"=>'checkNull','readonly']) !!}
                @else
        ...
        <li class="allLi">
            ...
            <div class="liRight">
                {!!  Form::hidden('product_colour',old('product_colour'),['v-model'=>'color']) !!}
                {!!  Form::hidden('two_code',old('two_code')) !!}
