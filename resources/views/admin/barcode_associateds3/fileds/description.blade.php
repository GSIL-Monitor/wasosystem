<li class="allLi">
    ...
    <div class="liRight">
        {!!  Form::text('supplier_managements_id',
        ...
        入库备注:{!!  Form::textarea(null,  $barcode_associated['procurement_plan']->postscript ?? '',['placeholder'=>'入库备注',"class"=>'','disabled']) !!}
        出库备注:{!!  Form::textarea(null, $barcode_associated['warehouse_out_management']->postscript ?? '',['placeholder'=>'出库备注',"class"=>'','disabled']) !!}
        信息备注:{!!  Form::textarea('postscript',old('postscript', $barcode_associated['barcode_associated']->postscript ?? ''),['placeholder'=>'信息备注',"class"=>'']) !!}
    </div>
    <div class="clear"></div>
</li>