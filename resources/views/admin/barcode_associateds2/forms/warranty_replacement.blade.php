<div class="JJList">
    <ul class="halfTwoUl" id="app">
        ...
        <li>
            ...
            <div class="liRight">
                {!!  Form::hidden('product_good_id',old('product_good_id',$barcode_associated['product_good']->id),['placeholder'=>'产品规格',"class"=>'checkNull product_good_id','readonly']) !!}
        ...
        <li>
            ...
            <div class="liRight">
                {!!  Form::text(null,$barcode_associated['warehouse_out_management']->updated_at,['placeholder'=>'受理时间',"class"=>'checkNull','readonly']) !!}
            </div>
            <div class="clear"></div>
        </li>
        ...
        <li>
            ...
            <div class="liRight">
                {!!  Form::text(null,config('status.barcode_associateds_type')[$barcode_associated['warehouse_out_management']->out_type],['placeholder'=>'当前事件',"class"=>'checkNull','readonly']) !!}
            </div>
            <div class="clear"></div>
        </li>
