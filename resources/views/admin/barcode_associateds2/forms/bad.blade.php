<div class="JJList">
    <ul class="halfTwoUl" id="app">
        ...
        <li>
            ...
            <div class="liRight">
                {!!  Form::text(null,optional($barcode_associated['barcode_associated']->procurement_plans)->updated_at ?? $barcode_associated['barcode_associated']->updated_at,['placeholder'=>'入库时间',"class"=>'checkNull','readonly']) !!}
            </div>
            <div class="clear"></div>
        </li>
        <li>
        ...
        <li>
            ...
            <div class="liRight">
                @if(Request::has('type'))
                    ...
                    @else
                    {!!  Form::select('current_state',array_only(config('status.barcode_associateds_type'),['returned_to_the_factory','models_to_replace','stock_returns','breakage']),old('current_state'),['placeholder'=>'选择事件',"class"=>'checkNull','v-model'=>'selected','@change'=>'changeSelect()']) !!}
                    @endif
            </div>
            <div class="clear"></div>
        </li>
        @endif
            <li v-if="showSelect">
                ...
                <div class="liRight">
                    {!!  Form::select('new_product_id',product()->pluck('title','id'),old('new_product_id'),['placeholder'=>'产品新类型',"class"=>'checkNull product']) !!}
                </div>
                <div class="clear"></div>
            </li>
            <li v-if="showSelect">
                ...
                <div class="liRight product_good">
                    {!!  Form::select('new_product_good_id',[],old('new_product_good_id'),['placeholder'=>'产品新规格',"class"=>'checkNull good']) !!}
                </div>
                <div class="clear"></div>
            </li>
        <li>
        ...
        <li class="allLi">
            ...
            <div class="liRight">
                {!!  Form::hidden('product_colour',old('product_colour')) !!}
