                ...
                <tab-pane label="客户客情信息" icon="android-person-add">
                    ...
                    @if(!Route::is('admin.visitor_details.create'))
                        ...
                        <li>
                            ...
                            <div class="liRight">
                                {!!  Form::text(null,isset($visitor_detail->user->deal) && $visitor_detail->user->deal==1? '已成交':'未成交',['placeholder'=>'成交情况',"readonly"]) !!}
                    ...
                    <li>
                        ...
                        <div class="liRight">
                            {!!  Form::text(null,$visitor_detail->admin_name->name ?? auth('admin')->user()->name,['placeholder'=>'值班客服',"readonly"]) !!}
