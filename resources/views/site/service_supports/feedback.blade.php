        ...
        <div class="wrap">
            <div class="form_box" id="app">
                ...
                <p>我们将在第一时间进行阅读以及商讨您的建议，如果您的建议符合我们的改进条件及要求，我们将尽快完成修改。修改最新近况我们将以邮件方式反馈给您。</p>
                    {{ Form::open(['route'=>'service_support.feedback_save','onsubmit'=>'return false;','class'=>'feedback_save']) }}
                <input
                ...
                <span class="feedback_error"  v-show="errors.has('email')"><i></i>
                  ...
                  />
                    ...
                    <div class="checkPic">
                        ...
                        <div class="code_pic">
                            <img title="点击刷新" id="che_pic" height="40" src="{!! captcha_src('waso') !!}" onClick="this.src=this.src+'?'+Math.random()" style="cursor: pointer">
                        </div>
                        <div class="clear"></div>
                    </div>
                ...
                {{ Form::close() }}
                <div class="pro_feed">*我遇到的是关于产品的技术问题<a href="{{ route('service_support.index') }}">点击这里</a>*</div>
            </div>
