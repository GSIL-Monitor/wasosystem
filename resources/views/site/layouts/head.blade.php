...
<div id="header">
    <div class="wrap headWrap ">
        <div class="logo">
            <a href="/"><img src="{{ json_decode(getImages(setting('system_logo')),true)[0]['url'] }}"/></a>
        </div>

        <div class="user_control">
            <div class="headPhone">
                <a href="/"><img src="{{ json_decode(getImages(setting('contact_custome_hotline')),true)[0]['url'] }}"></a>
            </div>
