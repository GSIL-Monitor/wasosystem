...
<div class="body ITEasy">
    ...
    <div class="disignDiy" >
                                    ...
                                    <div class="liBox">
                                        ...
                                        <div class="induce">
                                            <div class="inducePage">
                                                ...
                                                <div class="priceBox">
                                                    <p>基数：<b>{{ $item2->details['product_base'] }}台起</b></p>
                                                    @guest('user')
                                                        <p>更多请联系在线客服</p>
                                                        <p>&nbsp;</p>
                                                        @else
                                                            @php $unit_price=$item2->price[user()->grade] ?? $item2->price['retail_price'];@endphp
                                                            <p>单价：<b>{{ $unit_price }}{{ $item2->details['tally'] }}</b></p>
       ...
       @foreach($its as $it)
           @if($loop->iteration !=1)
                <div class="serverBox serverBox2 txtCon" data_phone="{{ asset('pic/IT/IT_page'.$loop->iteration.'_p.jpg') }}" style="background-image:url({{ asset('pic/IT/IT_page'.$loop->iteration.'.jpg') }});">
                    <div class="wrap">
