    ...
    <div class="editInfo">
        <div class="DoneInfo">
            ...
            <div class="editName">
                ...
                {!!  Form::hidden('price_spread',$completeMachine->price['balance'] ?? 0,["class"=>'price_spread']) !!}
                <h5 class="xinghao"> {!!  Form::text('machine_model',$completeMachine->name,["class"=>'xh name','readonly']) !!}</h5>
                {!!  Form::hidden('code',$completeMachine->code,["class"=>'codes']) !!}
                <input type="hidden" value="{{ $completeMachine->parent_id == 1 ? 3 :4 }}" class="code" />
                {!!  Form::hidden('order_type',$completeMachine->parent_id == 1 ? 'waso_complete_machine' :'designer_computer') !!}
