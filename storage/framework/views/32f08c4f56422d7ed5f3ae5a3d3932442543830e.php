                ...
                <div class="proEasy">
                            ...
                            <span class="colBtn
                                ...
                                <?php if(!empty(user()) && $falg): ?>
                                    <i></i><em data_add_url="<?php echo e(route('server.collect',$server->id)); ?>"
                                               data_del_url="<?php echo e(route('server.collectRemove',$server->id)); ?>">取消收藏</em>
                                <?php else: ?>
                                    <i></i><em data_add_url="<?php echo e(route('server.collect',$server->id)); ?>"
                                               data_del_url="<?php echo e(route('server.collectRemove',$server->id)); ?>"
                                    >添加收藏</em>
                                <?php endif; ?>
                            </span>
...
<?php echo e($servers->appends(Request::except(['_token','page']))->links('vendor.pagination.ajax_page')); ?>
