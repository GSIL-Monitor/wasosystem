        ...
        <?php $__empty_1 = true; $__currentLoopData = $barcode_associateds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$barcode_associated): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr>
                ...
                <td class="tableInfoDel  tablePhoneShow  tableName"><a class="changeWeb"
                                                                       data_url="<?php echo e(route('admin.barcode_associateds.create')); ?>?status=<?php echo e($status); ?>&id=<?php echo e($barcode_associated['barcode_associateds']->id); ?><?php echo e(array_to_url(array_except($barcode_associated,'barcode_associateds'))); ?>"><?php echo e($key); ?></a>
                </td>
                <td><?php echo e($barcode_associated['product_good_type']); ?></td>
                <td><?php echo e($barcode_associated['product_good_name']); ?></td>
                <td><?php echo e($barcode_associated['barcode_associateds']->supplier_managements->code); ?> <?php echo e($barcode_associated['barcode_associateds']->supplier_managements->name); ?></td>
                <td><?php echo e($barcode_associated['purchase'] ?? $barcode_associated['admin']); ?></td>
                <td><?php echo e($barcode_associated['admin']); ?></td>
