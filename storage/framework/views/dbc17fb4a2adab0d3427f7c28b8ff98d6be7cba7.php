                ...
                <Tabs>
                    <tab-pane label="整机基本参数" icon="clipboard">
                        ...
                        <li>
                            ...
                            <div class="liRight">
                                <?php echo Form::text('quality_time',old('quality_time'),['placeholder'=>'整机质保(年)','class'=>'checkNull OneNumber']); ?>
                            ...
                            <div class="liRight">
                                <table class="listTable">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $complete_machine_product_goods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_good): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <tr>
                                            <td class="tableInfoDel" ><input class="selectBox selectIds" type="checkbox" name="id[]" value="<?php echo e($product_good->id); ?>"></td>
                                            <td class="">
                                        ...
                                        <td colspan="8">
                                            <div class="addPro" >
                                                ...
                                                <input class="red AllDel Btn"
                                                       data_url="<?php echo e(url('/waso/complete_machines/destory')); ?>?goodDel=<?php echo e($complete_machine->id ?? 'admins'); ?>&complete_machine_id=<?php echo e($complete_machine->id ?? Auth::user()->id); ?>"
                        ...
                        <li class="allLi">
                            ...
                            <div class="liRight">
                                ...
                                <?php $priceSun=priceSum($complete_machine_product_goods) ;?>
                                <?php $__currentLoopData = config('status.complete_machine_prices'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($key=='balance'): ?>
                                        <label class="priceLabel">
                                            ...
                                            <div class="priceCont"><?php echo Form::text('price['.$key.']',old('price['.$key.']',$complete_machine->price[$key] ?? 0),['placeholder'=>'请输入'.$value,'class'=>'checkNull OneNumber zyw_w58','id'=>$key,'original_price'=>$productGood->price[$key] ?? 0]); ?>

                                        </label>
                                    <?php else: ?>
                                        <label class="priceLabel">
                                            <div class="priceTit"><?php echo e($value); ?>：</div>
                                            <div class="priceCont"><?php echo Form::text('price['.$key.']',old('price['.$key.']',$priceSun[$key]),['placeholder'=>'请输入'.$value,'readonly','class'=>'checkNull OneNumber zyw_w58','id'=>$key]); ?></div>
                                        </label>
                                    <?php endif; ?>
                        ...
                        <li>
                            ...
                            <div class="liRight">
                                <?php echo Form::text('weight',old('weight'),['placeholder'=>'重量(Kg)','class'=>'OneNumber']); ?>
