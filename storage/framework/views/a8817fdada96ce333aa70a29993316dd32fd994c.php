...
<?php $__env->startSection('content'); ?>
    <div class="nowWebBox">
        <div class="PageBtn">
            ...
            'url'=>route('admin.put_in_storage_managements.in_unfinished'),
                ...
                <table class="listTable">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $put_in_storage_managements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $put_in_storage_management): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo e($put_in_storage_management->finish_procurement_number); ?></td>
                            <td><span class="redWord"><?php echo e(config('status.procurement_plans_statuss')[$put_in_storage_management->procurement_status]); ?></span></td>
                            ...
                            <td class=""><a class="changeWeb"
                                            data_url="<?php echo e(route('admin.put_in_storage_managements.two_code',$put_in_storage_management->id)); ?>">二级条码</a></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr><td colspan="12"><div class='error'>没有数据</div></td></tr>
                    <?php endif; ?>
                </table>
                <?php echo e($put_in_storage_managements->appends(Request::except('page'))->links()); ?>
