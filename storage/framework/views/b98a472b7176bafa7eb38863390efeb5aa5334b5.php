<dl class="activeDl">
    <dd>
        <div class="proBoxes">
            <ul>
                <?php $__currentLoopData = $common_complete_machines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key !='0' && $key !=''): ?>
                    <li>
                        <div class="pro_pic">
            ...
            <a href="<?php echo e(route('server.index','complete_machine')); ?>" class="lookMore"><i></i>查看全部</a>
        </div>
    </dd>
    <div class="clear"></div>
</dl>