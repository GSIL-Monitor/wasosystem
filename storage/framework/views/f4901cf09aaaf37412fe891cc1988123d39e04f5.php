            ...
            <table class="listTable">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $product_goods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_good): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="tableMoreHide"><?php echo e($product_good->product_goods_order->sum('pivot.product_good_num')); ?></td>
                        <td class="tableMoreHide"><?php echo e(optional($product_good->inventory_management)->new ?? 0); ?></td>
                        <td class="tableMoreHide"><?php echo e(optional($product_good->inventory_management)->good ?? 0); ?></td>
                        <td class="tableMoreHide"><?php echo e(optional($product_good->inventory_management)->bad ?? 0); ?></td>
                ...
                <?php echo e($product_goods->appends(Request::except(['_token','page']))->links()); ?>
