<div class="editBoxWrap">
    ...
    <div class="editInfo">
        <div class="DoneInfo">
            <div class="headPic radius"><img src="<?php echo e(order_complete_machine_pic($common_equipment->common_equipment_product_goods)); ?>"></div>
            <div class="editName">
                ...
                <?php echo Form::hidden('price_spread', 0,["class"=>'price_spread']); ?>

                <h5 class="xinghao"> <?php echo Form::text('machine_model',$common_equipment->machine_model,["class"=>'xh name','readonly']); ?></h5>
                <?php echo Form::hidden('code',$common_equipment->code,["class"=>'codes']); ?>

                <input type="hidden" value="<?php echo e($parameters['order_type_code'][$common_equipment->order_type]); ?>" class="code" />
                <?php echo Form::hidden('order_type',$common_equipment->order_type); ?>
