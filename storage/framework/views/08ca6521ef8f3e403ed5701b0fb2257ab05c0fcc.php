    ...
    <li>
        ...
        <div class="liRight">
            <?php echo Form::text('serial_number',old('serial_number', 'CK'.date('YmdHis',time())),['placeholder'=>'序列号',"class"=>'checkNull','readonly']); ?>
    ...
    <li>
        ...
        <div class="liRight">
            <?php echo Form::select('user_id',$users,old('user_id'),['placeholder'=>'收货单位',"class"=>'checkNull select2']); ?>
