...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="<?php echo e(route('log-viewer::dashboard')); ?>" class="navbar-brand mr-0">
            <i class="fa fa-fw fa-book"></i> 日志查看器
        </a>
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            <p class="text-muted pull-left">
                网烁日志查看器 - <span class="badge badge-info">version <?php echo e(log_viewer()->version()); ?></span>
            </p>
            <p class="text-muted pull-right">
                Created with <i class="fa fa-heart"></i> by 网烁 <sup>&copy;</sup>
            </p>
        </div>
    </footer>
