<div class="JJList">
    <ul class="halfTwoUl" id="app">
        <?php if(Route::is('admin.procurement_plans.create')): ?>
            <?php echo Form::open(['route'=>'admin.procurement_plans.store','method'=>'post','id'=>'procurement_plans','onsubmit'=>'return false']); ?>

            <li>
                <div class="liLeft">预购序列号：</div>
                <div class="liRight">
                    <?php echo Form::text('serial_number',old('serial_number',$procurement_plan->serial_number ?? 'YG'.date('YmdHis',time())),['placeholder'=>'procurement_plan',"class"=>'checkNull','readonly']); ?>

                </div>
                <div class="clear"></div>
            </li>
        <?php else: ?>
            <?php echo Form::model($procurement_plan,['route'=>['admin.procurement_plans.update',$procurement_plan->id],'id'=>'procurement_plans','method'=>'put','onsubmit'=>'return false']); ?>
        ...
        <?php endif; ?>
            ...
            <li>
                ...
                <div class="liRight">
                    <?php echo Form::text('procurement_number',old('procurement_number'),['placeholder'=>'采购数量',"class"=>'checkNull OneNumber',':disabled'=>'isFinishDisabled']); ?>
            ...
            <li>
                ...
                <div class="liRight">
                    <?php echo Form::hidden('purchase',old('purchase',$procurement_plan->purchase ?? auth('admin')->user()->id),['placeholder'=>'采购人员',"class"=>'checkNull']); ?>

                    <?php echo Form::text(null,$procurement_plan->purchases->name ?? auth('admin')->user()->name,['placeholder'=>'采购人员',"class"=>'checkNull','readonly']); ?>
            ...
            <li>
                ...
                <div class="liRight">
                    <?php echo Form::text('logistics_company',old('logistics_company'),['placeholder'=>'物流公司',"class"=>'',':disabled'=>'isFinishDisabled']); ?>
            ...
            <li>
                ...
                <div class="liRight">
                    <?php echo Form::text('logistics_number',old('logistics_number'),['placeholder'=>'物流单号',"class"=>'',':disabled'=>'isFinishDisabled']); ?>
            ...
            <li class="allLi">
                ...
                <div class="liRight">
                    <?php echo Form::textarea('postscript',old('postscript'),['placeholder'=>'备注信息',"class"=>'',':disabled'=>'isFinishDisabled']); ?>
...
<script>
    var vm=new Vue({
        el:"#app",
        data:{
            <?php if(isset($procurement_plan) && $procurement_plan->procurement_status == 'procurement' && $procurement_plan->purchase != auth('admin')->user()->id): ?>
            isDisabled:true,
            isShow:true,
            isFinishDisabled:true,
            <?php elseif(isset($procurement_plan) && $procurement_plan->procurement_status == 'finish'): ?>
            isDisabled:true,
            isShow:true,
            isFinishDisabled:true,
            <?php else: ?>
