                ...
                <table class="listTable">
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show user_addresses')): ?>
                                <a class="changeWeb"
                                   data_url="<?php echo e(route('admin.user_addresses.index')); ?>?user_id=<?php echo e($user->id); ?>">物流</a>
                                <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show user_companies')): ?>
                                    <a class="changeWeb"
                                       data_url="<?php echo e(route('admin.user_companies.index')); ?>?user_id=<?php echo e($user->id); ?>">单位</a>
                                     <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show common_equipments')): ?>
                                        <a class="changeWeb"
