    ...
    <li>
        ...
        <div class="liRight">
            <?php echo Form::hidden('user_id',old('user_id'),['placeholder'=>'收货单位',"class"=>'checkNull']); ?>

            <?php echo Form::text(null,old('user_id',$warehouse_out_management->user->username .' - '.$warehouse_out_management->user->nickname),['placeholder'=>'收货单位',"class"=>'checkNull','readonly']); ?>
    ...
    <li>
        ...
        <div class="liRight">
            <?php echo Form::text('out_number',old('out_number'),['placeholder'=>'确认数目',"class"=>'checkNull','v-model'=>'out_storage_storage_counts']); ?>
