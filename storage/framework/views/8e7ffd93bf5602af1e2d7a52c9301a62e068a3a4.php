                ...
                <?php $__empty_1 = true; $__currentLoopData = $demand_management_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="tableInfoDel">
                            <input class="selectBox selectIds" type="checkbox" name="id[]" value="<?php echo e($item->id); ?>">
                        </td>
...
<fieldset>
    ...
    <li>
        ...
        <div class="liRight">
            <?php echo Form::select('assistant[]',$parameters['admins'],old('assistant[]'),['placeholder'=>'协同帮助人员',"class"=>'checkNull select2','multiple']); ?>
