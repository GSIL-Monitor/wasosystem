<dl>
    <dd>
        <div class="proBoxes">
            <ul>
                <?php $__currentLoopData = $graphic_workstation_designer_computer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key !='0' && $key !=''): ?>
                    <li>
                        <div class="pro_pic">
                            <a href="<?php echo e(route('server.index',$complete_machine_category[$key])); ?>">
            ...
            <a href="<?php echo e(route('server.index','graphic_workstation_designer_computer')); ?>" class="lookMore"><i></i>查看全部</a>
        </div>
    </dd>
    <div class="clear"></div>
</dl>