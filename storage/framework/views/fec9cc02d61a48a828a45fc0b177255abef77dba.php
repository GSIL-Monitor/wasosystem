...
<div class="condition">
        <div :class="{hide_condition:true,opend:condition_more}" >
             <?php $__currentLoopData = $server_filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$server_filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
