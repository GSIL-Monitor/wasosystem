...
<?php $__env->startSection('content'); ?>
    <div class="nowWebBox">
        <div class="PageBtn">
            <div class="phoneBtns">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create we_chat_application_managements')): ?>
                 ...
                 <?php endif; ?>
                <?php else: ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit we_chat_application_managements')): ?>
                    <button type="submit" class="Btn common_add" form_id="we_chat_application_managements"
        ...
        <div class="PageBox">
            <?php echo $__env->make('admin.we_chat_application_managements.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </div>
