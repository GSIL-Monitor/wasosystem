            ...
            <Tabs>
                <tab-pane label="订单详情" icon="clipboard">
                    ...
                    <li class="allLi">
                        ...
                        <div class="liRight">
                            ...
                            <?php if($order->order_status =='intention_to_order' || auth('admin')->user()->can('super edit')): ?>
                                <a class="alertWeb" data_url="<?php echo e(route('admin.orders.show',$order->id)); ?>">修改配置</a>
                            <?php endif; ?>
                        </div>
                        <div class="clear"></div>
                    </li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="num">
                                            <input type="text" readonly="" class="PJnum good_num zyw_w50"
                                                   ...
                                                   value="<?php echo e($product_good->pivot->product_good_num / $order->num); ?>"
                                                   product-name="<?php echo e($product_good->product->title); ?>"
                                                   product-bianhao="<?php echo e($product_good->product->bianhao); ?>"
                                                   good-id="<?php echo e($product_good->id); ?>"
                                                   good-framework="<?php echo e($product_good->framework->name); ?>"
                                                   good-jianma="<?php echo e($product_good->jianma); ?>">
                                            <?php echo e($product_good->pivot->product_good_raid == '请选择raid' ? '' : $product_good->pivot->product_good_raid); ?>

                                        </td>
                                        <td data-price="<?php echo e($product_good->pivot->product_good_price); ?>"
                                            class="product_good_price"><?php echo e($product_good->pivot->product_good_price); ?></td>
                                    ...
                                    <tr>
                                        <td class="num">
                                            <input type="hidden" class="PJnum good_num"
                                                   ...
                                                   product-bianhao="<?php echo e($power->product->bianhao); ?>" good-id="<?php echo e($power->id); ?>"
                                ...
                                <tr>
                                    <td colspan="6">
                                        ...
                                        $img=$identifying[$model] ?? $identifying['DE'];
                                            ?>
                                            <a target="_blank"
                                               href="<?php echo e(route('admin.orders.export',$order->id)); ?>?export=Publicity&img=<?php echo e($img); ?>&export_name=宣传单页">【宣传单页】</a>
                                            <a class="contract_alert">【合同模版】</a>
                                            <a href="<?php echo e(route('admin.orders.export',$order->id)); ?>?view=measuring&export=Measuring&export_name=借测模版">【借测模版】</a>
                                            <a href="<?php echo e(route('admin.orders.export',$order->id)); ?>?export=Delivery&export_name=出库表">【出库表】</a>
                                            <?php if(str_contains($order->order_status,['order_acceptance','in_transportation','arrival_of_goods'])): ?>
                    ...
                    <li>
                        ...
                        <div class="liRight">
                            <?php echo Form::text('unit_price',old('unit_price'),['placeholder'=>'订单金额',"class"=>'checkNull unit_price OneNumber','readonly',':disabled'=>'isDisabled']); ?>
                    ...
                    <li>
                        ...
                        <div class="liRight">
                            <?php echo Form::text('total_prices',old('total_prices'),['placeholder'=>'总金额',"class"=>'checkNull total_prices OneNumber',':disabled'=>'isDisabled']); ?>
                    ...
                    <li>
                        ...
                        <div class="liRight">
                            <?php if($order->payment_status == 'account_paid' ): ?>
                                ...
                                <?php echo Form::text('payment_status',old('payment_status',$parameters['payment_status'][$order->payment_status]),['placeholder'=>'款项状态',"class"=>'checkNull',':disabled'=>'isDisabled']); ?>
                    ...
                    <li>
                        ...
                        <div class="liRight">
                            <?php echo Form::text('parcel_count',old('parcel_count'),['placeholder'=>'包裹件数',"class"=>'checkNull OneNumber',':disabled'=>'pack']); ?>
                    ...
                    <li class="Li50">
                        ...
                        <div class="liRight">
                            <?php echo Form::textarea('user_remark',old('user_remark'),['placeholder'=>'客户要求',"class"=>'',':readonly'=>'isDisabled','title'=>optional($order)->user_remark ?? '']); ?>
                    ...
                    <li class="Li50">
                        ...
                        <div class="liRight">
                            <?php echo Form::textarea('company_remark',old('company_remark'),['placeholder'=>'公司备注',"class"=>'',':readonly'=>'isDisabled','title'=>optional($order)->company_remark ?? '']); ?>
