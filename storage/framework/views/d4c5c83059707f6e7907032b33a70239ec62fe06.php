    ...
    <ul class="maxUl" >
        ...
        <?php endif; ?>
            ...
            <li>
                ...
                <div class="liRight">
                    <?php echo Form::text('num',old('num'),['placeholder'=>'订单金额',"class"=>'checkNull order_num OneNumber',':disabled'=>'isDisabled']); ?>
            ...
            <li class="invoice_infos">
                ...
                <div class="liRight">
                    <?php echo Form::select('invoice_info',array_prepend($order->user->user_company()->pluck('name','id')->toArray(),'请选择开票信息',''),old('invoice_info'),['placeholder'=>'开票信息',"class"=>'checkNull invoice_info',':disabled'=>'isDisabled']); ?>
