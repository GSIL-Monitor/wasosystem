                ...
                <?php $__currentLoopData = $product_paramenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_paramenter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td ><input type="text"  name="edit[<?php echo e($product_paramenter->id); ?>][danwei]"
                                   value="<?php echo e($product_paramenter->danwei); ?>" class="zyw_w50"></td>
                        <td class="">
                        ...
                        <td>
                            <Poptip trigger="hover">
                                <span style="cursor:pointer"><?php echo e(config('status.procuctParamentselectShow')[$product_paramenter->type]); ?></span>
                                <div slot="content">
                        ...
                        <td class="tableMoreHide"><?php echo e($product_paramenter->updated_at->format('Y-m-d')); ?></td>
