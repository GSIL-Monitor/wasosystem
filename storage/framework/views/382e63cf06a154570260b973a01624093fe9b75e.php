<div class="JJList">
    <ul class="halfTwoUl" id="app">
        ...
        <li>
            ...
            <div class="liRight">
                <?php echo Form::hidden('product_good_id',old('product_good_id',$barcode_associated['barcode_associated']->product_good->id),['placeholder'=>'产品规格',"class"=>'checkNull product_good_id','readonly']); ?>
        ...
        <li>
            ...
            <div class="liRight">
                <?php echo Form::text(null,$barcode_associated['barcode_associated']->procurement_plans->updated_at,['placeholder'=>'入库时间',"class"=>'checkNull','readonly']); ?>
        ...
        <li>
            ...
            <div class="liRight">
                ...
                <?php else: ?>
                    <?php if($barcode_associated['barcode_associated']->current_state == 'returned_to_the_factory'): ?>
                        <?php echo Form::select('current_state',array_only(config('status.barcode_associateds_type'),['factory_return']),old('current_state'),['placeholder'=>'选择事件',"class"=>'checkNull select2']); ?>

                    <?php else: ?>
                        <?php echo Form::select('current_state',array_only(config('status.barcode_associateds_type'),['quality_return']),old('current_state'),['placeholder'=>'选择事件',"class"=>'checkNull select2']); ?>
        ...
        <li>
            ...
            <div class="liRight">
                ...
                <?php echo Form::text(null,admin()->name,['placeholder'=>'关联客户',"class"=>'checkNull','readonly']); ?>
                    ...
                    <?php else: ?>
                    <?php echo Form::text(null,$admin_id[$barcode_associated['barcode_associated']->admin],['placeholder'=>'关联客户',"class"=>'checkNull','readonly']); ?>
