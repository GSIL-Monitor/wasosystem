<div class="JJList">
    <ul class="halfTwoUl" id="app">
        ...
        <li>
            ...
            <div class="liRight">
                <?php echo Form::text(null,$barcode_associated['barcode_associated']->updated_at,['placeholder'=>'代管时间',"class"=>'checkNull','readonly']); ?>
        ...
        <?php if(!Request::has('search')): ?>
            <li>
                ...
                <div class="liRight">
                    ...
                    <?php else: ?>
                        <?php echo Form::select('current_state',array_only(config('status.barcode_associateds_type'),['quality_take_away','escrow_to_storage','breakage']),old('current_state'),['placeholder'=>'选择事件',"class"=>'checkNull','v-model'=>'selected','@change'=>'changeSelect()']); ?>
        ...
        <?php else: ?>
            <li>
                ...
                <div class="liRight">
                    <?php echo Form::select('product_colour',array_only(config('status.barcode_associateds_type'),['new','good','bad']),old('product_colour'),['placeholder'=>'产品成色',"class"=>'checkNull','disabled']); ?>
            ...
            <li>
                ...
                <div class="liRight">
                    <?php echo Form::text('two_code',old('two_code'),['placeholder'=>'关联条码',"class"=>'checkNull','disabled']); ?>
        ...
        <li  v-if="showSelect">
            <div class="liLeft">产品成色：</div>
            <div class="liRight">
                <?php echo Form::select('product_colour',array_only(config('status.barcode_associateds_type'),['new','good','bad']),old('product_colour',''),['placeholder'=>'产品成色',"class"=>'checkNull select2','v-model'=>'color']); ?>
        ...
        <li>
            ...
            <div class="liRight">
                <?php if(Request::has('search')): ?>
                    <?php echo Form::text('admin',old('admin',$admin_id[$barcode_associated['barcode_associated']->admin]),['placeholder'=>'关联客户',"class"=>'checkNull','readonly']); ?>
        ...
        <li class="allLi">
            ...
            <div class="liRight">
                <?php echo Form::hidden('product_colour',old('product_colour'),['v-model'=>'color']); ?>
