    ...
    <div class="disignDiy" >
                                    ...
                                    <div class="liBox">
                                        ...
                                        <div class="induce">
                                            <div class="inducePage">
                                                ...
                                                <div class="priceBox">
                                                    <p>基数：<b><?php echo e($item2->details['product_base']); ?>台起</b></p>
                                                    <?php if(auth()->guard('user')->guest()): ?>
                                                        <p>更多请联系在线客服</p>
                                                        <p>&nbsp;</p>
                                                        <?php else: ?>
                                                            <?php $unit_price=$item2->price[user()->grade] ?? $item2->price['retail_price'];?>
                                                            <p>单价：<b><?php echo e($unit_price); ?><?php echo e($item2->details['tally']); ?></b></p>
                                                            <p>总价：<b><?php echo e($item2->details['product_base'] * $unit_price); ?><?php echo e($item2->details['tally']); ?></b></p>
                                                    <?php endif; ?>
                                                </div>
                                                <button <?php if(auth()->guard('user')->guest()): ?> onclick="location.href='<?php echo e(route('login')); ?>'" <?php else: ?>  <?php endif; ?>>意向保存</button>
                                            </div>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
       ...
       <?php $__currentLoopData = $its; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <?php if($loop->iteration !=1): ?>
                <div class="serverBox serverBox2 txtCon" data_phone="<?php echo e(asset('pic/IT/IT_page'.$loop->iteration.'_p.jpg')); ?>" style="background-image:url(<?php echo e(asset('pic/IT/IT_page'.$loop->iteration.'.jpg')); ?>);">
                    <div class="wrap">
