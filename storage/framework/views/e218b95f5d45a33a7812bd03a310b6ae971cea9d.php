...
<?php echo $__env->make('admin.common.field._select',['title'=>'选择事件','field'=>'current_state','field_list'=>array_only(config('status.barcode_associateds_type'),['quality_take_away','escrow_to_storage','breakage']),'other'=>['placeholder'=>'请选择事件','class'=>'checkNull','v-model'=>'selected','@change'=>'changeSelect()']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
