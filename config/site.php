...
//               'quality'=>['name'=>'质保管理'],
               'collect.index'=>['name'=>'我的收藏','image'=>'P_shopColl.png','grade'=>'unverified'],
//               'query'=>'产品查询',
           ],
           '个人中心'=>[
               'notifications.index'=>['name'=>'消息通知','image'=>'P_message.png','grade'=>'unverified'],
               'personal_details.index'=>['name'=>'个人信息','image'=>'P_shopMe.png','grade'=>'unverified'],
               'user_companies.index'=>['name'=>'企业信息','image'=>'P_company.png','grade'=>'unverified'],
               'user_addresses.index'=>['name'=>'收货地址','image'=>'P_shou.png','grade'=>'unverified'],
               'personal_details.password_edit'=>['name'=>'密码修改','image'=>'P_shopPass.png','grade'=>'unverified'],
               'binding_authorization.index'=>['name'=>'绑定授权','image'=>'P_bind.png','grade'=>'unverified'],
           ]
       ],
